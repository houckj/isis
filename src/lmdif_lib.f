cJCH: 8/2006, modified netlib version of lmdif1.f
c             to provide epsfcn as a function argument
      subroutine lmdif1(fcn,m,n,x,fvec,norm2,tol,epsfcn,maxfev,info,
     &  iwa,wa,lwa)
      integer m,n,maxfev,info,lwa
      integer iwa(n)
      double precision tol,norm2,epsfcn
...
c
c     **********
      integer mode,mp5n,nfev,nprint
      double precision factor,ftol,gtol,xtol,zero,enorm
