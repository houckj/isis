...
Several minimization algorithms are available: {\tt lmdif} and
{\tt marquardt} are Levenberg-Marquardt algorithms with
numerical derivatives; {\tt simann} is a simulated annealing
method; {\tt subplex} is a variant of the Nelder-Mead simplex
algorithm. The latter two approaches may require more function
evaluations to find the minimum, but may be less likely to
