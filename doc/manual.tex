...
By default, the computations are done in parallel, using all
available CPU cores.  Use the \verb|serial| qualifier to force
the computations to be performed on a single CPU core.
...
instances of isis running on a single multi-core computer.  To
coordinate multiple isis processes running on different
