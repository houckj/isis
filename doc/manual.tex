...
{conf\_grid, plot\_conf, save\_conf, load\_conf, conf\_map\_flux, multicore}
...
{fit\_counts, eval\_counts, fit\_flux, eval\_flux, save\_par, fit\_search\_info, multicore}
...
\verb|serial| qualifier. See \verb|multicore| for more details
...
{marquardt, lmdif, simann, subplex, set\_fit\_method, multicore}
...
\end{verbatim}
See \verb|multicore| for more details on controlling parallel processes.
...
the slave processes exit.  If non-\verb|NULL|, the message
...
For a detailed example of how the \verb|while_| qualifier
can be used to implement the three-section loop described
above, look at the implementation of the \verb|plm|
fit-method (\verb|isis/share/plm.sl|).
