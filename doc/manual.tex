...
{set\_par (idx, value [,freeze, [ min, max [,step]]])} %usage
...
parameter step value may or may not be used.  Values
\verb|step<=0| indicate that no initial step size information
is available.
