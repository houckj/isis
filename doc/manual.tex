...
{plm, marquardt, simann, subplex, set\_fit\_method}
...
{plm, lmdif, simann, subplex, set\_fit\_method}
...
{marquardt, lmdif, simann, subplex, set\_fit\_method}
...
{subplex, plm, lmdif, marquardt, set\_fit\_method}
