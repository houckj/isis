...
available compute cores.  To specify the number of compute
slaves, use the \verb|num_slaves| qualifier.  To run the slave
processes at lower priority, include a qualifier of the form
\verb|nice=n|, where n is an integer in the range 1-19.  To
force serial execution, use the \verb|serial| qualifier.
