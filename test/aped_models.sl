...
variable supported_versions = ["1.3.1", "2.0.1", "2.0.2"];
...
if (max_abs_rel_diff > 0.02)
throw ApplicationError,
   "temp = $temp:  max_abs_rel_diff = $max_abs_rel_diff, expected <0.02"$;
